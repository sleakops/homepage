      ...
      <Box as="section">
        ...
        <Box as="section" pb="20">
          <Container py={{ base: '16', md: '24' }}>
            ...
            <Heading size={useBreakpointValue({ base: 'sm', md: 'md' })} pt={6} pb={4}>
              Privacy Policy
            </Heading>
            ...
            <Text as="li" fontSize="lg" py={4}> 
              "Company" (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Craftech-io, Inc. 651 North Broad Street Middletown, DE.
